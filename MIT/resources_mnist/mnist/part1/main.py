...
def run_softmax_on_MNIST(train_dct, temp_parameter=1):
    """
    ...
    """
    #train_x, train_y, test_x, test_y = get_MNIST_data()
    train_x, train_y, test_x, test_y = train_dct['train_x'], train_dct['train_y'], train_dct['test_x'], train_dct['test_y']
...
train_dct={'train_x':train_pca, 'train_y':train_y, 'test_x':test_pca, 'test_y':test_y}
# train_pca (and test_pca) is a representation of our training (and test) data
# after projecting each example onto the first 18 principal components.
pca_Error=run_softmax_on_MNIST(train_dct, temp_parameter=1)
print('PCA test_error=', pca_Error)
'''
...
#train_dct={'train_x':train_cube, 'train_y':train_y, 'test_x':test_cube, 'test_y':test_y}
# train_pca (and test_pca) is a representation of our training (and test) data
# after projecting each example onto the first 18 principal components.
#pca_Error=run_softmax_on_MNIST(train_dct, temp_parameter=1)
#print('Cubic features test_error=', pca_Error)
...
train_error = 1 - svm.score(train_pca10, train_y)
test_error = 1 - svm.score(test_pca10, test_y)
